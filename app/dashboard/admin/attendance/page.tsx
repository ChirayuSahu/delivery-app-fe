                                                    ...
                                                    <div className="flex items-center gap-3">
                                                        {personInfo.headPicUrl ? (
                                                            <img
                                                                ...
                                                                alt={fullName}
                                                                className="h-9 w-9 rounded-lg object-cover border border-slate-100 bg-slate-50"
                                                                onError={(e) => {
                                                        ...
                                                        <div
                                                            className={`h-9 w-9 rounded-lg bg-green-50 border border-green-100 items-center justify-center text-green-700 font-bold text-xs shrink-0 ${personInfo.headPicUrl ? 'hidden' : 'flex'}`}
                                                        >
