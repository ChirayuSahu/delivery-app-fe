...
export default function CreateUserButton({ children }: CreateUserButtonProps) {
    ...
    useEffect(() => {
        ...
        window.addEventListener('trigger-create-user', handleTrigger);
    ...
    const validateForm = () => {
        return formData.name && formData.email && formData.password && formData.phone.length === 10 && formData.esId && formData.type;
    };
                ...
                <form onSubmit={handleCreateUser}>
                    ...
                    <div className="grid gap-4 py-6">
                        ...
                        <div className="grid gap-2">
                            ...
                            <Input
                                id="email" name="email" type="email" placeholder={`john@${process.env.NEXT_PUBLIC_DOMAIN_NAME || 'example.com'}`}
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <div className="grid gap-2">
                                ...
                                <Input
                                    id="phone" name="phone" placeholder="9999999999"
                            ...
                            <div className="grid gap-2">
                                ...
                                <Input
                                    id="esId" name="esId" placeholder="123"
